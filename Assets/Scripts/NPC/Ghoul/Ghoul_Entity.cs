...
public class Ghoul_Entity : Entity, IDamage, IDetect
{
    ...
    public Ghoul_Patrol Ghoul_Patrol { get; set; }
    public Ghoul_Attack Ghoul_Attack { get; set; }
    public Ghoul_Dead Ghoul_Dead { get; set; }
    ...
    public override void Awake()
    {
        ...
        Ghoul_Idle = new Ghoul_Idle(this, stateMachine, "Idle", D_IdleState, this);
        Ghoul_Move = new Ghoul_Move(this, stateMachine, "Chase", D_MoveState, this);
        Ghoul_Attack = new Ghoul_Attack(this, stateMachine, "Attack", D_AttackState, this);
        Ghoul_Patrol = new Ghoul_Patrol(this, stateMachine, "Move", D_PatrolState, this);
    ...
    public override void MainHealthSet(float amount)
    {
        ...
        {
            CheckPoint = true;
            stateMachine.ChangeState(Ghoul_Dead);
    ...
    public override void TriggerDetection()
    {
        ...
        Ghoul_Idle.isIdleTimeOver = true;
...
public class Ghoul_Idle : IdleState
{
    Ghoul_Entity character;
    public Ghoul_Idle(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_IdleState stateData, Ghoul_Entity character) : base(entity, stateMachine, animBoolName, stateData)
    {
        ...
        if (!isExitingState && isIdleTimeOver /*&& character.CheckIfGrounded*/)
        {
            if (character.DetectionCheck)
            {
                if (character.CanSeePlayer)
                {
                    ...
                    if (character.Ghoul_Attack.CheckIfDistance() && character.Ghoul_Attack.CheckIfCanUseAbility())
                    {
                        character.Ghoul_Attack.PresetAttack();
                        stateMachine.ChangeState(character.Ghoul_Attack);
                    }
                    else if (character.Ghoul_Move.CheckIfCanMove())
                    {
                        stateMachine.ChangeState(character.Ghoul_Move);
                    }
                }
                else
                {
...
public class Ghoul_Move : MoveState
{
    Ghoul_Entity character;
    ...
    public override void LogicUpdate()
    {
        ...
        if (!isExitingState)
        {
            ...
            else if (character.Ghoul_Attack.CheckIfDistance() && character.Ghoul_Attack.CheckIfCanUseAbility())
            {
                character.Ghoul_Attack.PresetAttack();
                stateMachine.ChangeState(character.Ghoul_Attack);
            }
...
public class Ghoul_Patrol : PatrolState
{
    Ghoul_Entity character;
    Vector3 direction;
    public Ghoul_Patrol(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_PatrolState stateData, Ghoul_Entity character) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.character = character;
    }
...
public class Ghoul_Attack : AttackState
{
    Ghoul_Entity character;
    public Ghoul_Attack(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_AttackState stateData, Ghoul_Entity character) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.character = character;
    }
...
public class Ghoul_Dead : DeadState
{
    Ghoul_Entity character;

    public Ghoul_Dead(Entity entity, FiniteStateMachine stateMachine, string animBoolName, bool playAnim, D_DeadState stateData, Ghoul_Entity character) : base(entity, stateMachine, animBoolName, playAnim, stateData)
    {
        this.character = character;
    }
